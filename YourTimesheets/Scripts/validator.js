        ...
        var table = {
            datetime: {
                ...
                valid: function(value) {
                    // this is a dastardly validator for date/time, hacked in record time by 3 drunk monkeys
                    // please do not use it anywhere in your code unless you like being made fun of
                    ...
                    if (matches) {
                        ...
                        var tester = new Date(year, month, day, hours, minutes, seconds);
                        return tester && tester.getFullYear() == year
                            && tester.getMonth() == month && tester.getDate() == day
                            && tester.getHours() == hours && tester.getMinutes() == minutes
